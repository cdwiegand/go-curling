FROM --platform=linux/amd64    golang:1.25.3            AS build_amd64
FROM --platform=linux/arm64    golang:1.25.3            AS build_arm64
FROM --platform=linux/ppc64le  golang:1.25.3            AS build_ppc64le
